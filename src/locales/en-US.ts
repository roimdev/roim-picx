...
export default {
    ...
    admin: {
        ...
        apiKeyRevoke: 'Revoke',
        apiKeyRevokeConfirm: 'Are you sure you want to revoke this API Key? Applications using this key will no longer be able to access the API.',
        apiKeyCreatedTitle: 'API Key Generated',
        apiKeyCreatedMsg: 'Please make sure to copy and save your API Key now. For security reasons, it will not be shown again.',
