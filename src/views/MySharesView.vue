<template>
    <div class="mx-auto max-w-7xl my-8 px-4 sm:px-6 relative min-h-[60vh]">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <BaseButton @click="fetchMyShares" type="indigo">
                ...
                <div v-for="share in shares" :key="share.id"
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center gap-3 text-xs text-gray-400 dark:text-gray-500">
                            ...
                            <span v-if="share.expireAt"
                                class="hidden sm:flex items-center gap-1 text-amber-500 dark:text-amber-400">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <el-popconfirm :title="$t('myShares.deleteConfirmMsg')" :confirm-button-type="'danger'"
                            ...
                            <template #reference>
                                <BaseButton circle size="sm" type="danger">
