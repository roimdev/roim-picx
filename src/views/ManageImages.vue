<template>
    <div class="mx-auto max-w-7xl my-8 px-4 sm:px-6 relative min-h-[60vh]">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    已上传 <span class="font-medium text-gray-900 dark:text-gray-100">{{ uploadedImages.length }}</span>
                    张图片，
                    共占用 <span class="font-medium text-gray-900 dark:text-gray-100">{{ formatBytes(imagesTotalSize)
                        }}</span>
                </p>
            </div>
            <div class="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                ...
                <div class="relative w-full sm:w-auto">
                    ...
                    <input v-model="searchKeyword" type="text" placeholder="搜索图片..."
        ...
        <div v-else-if="!loading" class="py-20 text-center">
            ...
            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ searchKeyword ? '未找到匹配图片' : '暂无图片' }}
            </h3>
