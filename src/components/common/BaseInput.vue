    ...
    <div class="space-y-1.5 w-full">
        ...
        <div class="relative group">
            ...
            <textarea v-if="type === 'textarea'" :value="modelValue" :placeholder="placeholder" :readonly="readonly"
                ...
                class="w-full py-3 border border-gray-200 dark:border-gray-600 rounded-xl text-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all placeholder:text-gray-400 dark:placeholder:text-gray-600 outline-none disabled:opacity-60 disabled:cursor-not-allowed resize-none"
                :class="[
                    error ? 'border-red-500 focus:border-red-500 focus:ring-red-500/10' : '',
                    (!readonly && !disabled) ? 'bg-gray-50/80 dark:bg-gray-800/40 border-gray-100 dark:border-gray-600' : 'bg-gray-50/30 dark:bg-gray-900/30 cursor-default',
                    'px-4'
                ]"></textarea>
            ...
            <input v-else :value="modelValue" :type="type" :placeholder="placeholder" :readonly="readonly"
                ...
                class="w-full py-3 border border-gray-200 dark:border-gray-600 rounded-xl text-sm focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all placeholder:text-gray-400 dark:placeholder:text-gray-600 outline-none disabled:opacity-60 disabled:cursor-not-allowed"
                :class="[
