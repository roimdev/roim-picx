<template>
  <div class="group flex items-center gap-4 p-3 bg-white rounded-lg border border-gray-100 hover:shadow-sm transition-all duration-200">
    <!-- Thumbnail -->
...
import { faTrashAlt, faLink, faImage, faEdit } from '@fortawesome/free-solid-svg-icons'
